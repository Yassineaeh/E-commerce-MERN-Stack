      ...
      <div className="form">
        <form onSubmit={submitHandler} >
          <ul className="form-container">
            ...
            <li>
              <button type="button" onClick={() => setModalVisible(false)} className="button secondary">Precedent</button>
            </li>
          </ul>
        </form>
      </div>
      ...
      <table className="table">
        ...
        <tbody>
          {products.map(product => (<tr key={product._id}>
            ...
            <td>{product.brand}</td>
            <td>
              <button className="button" onClick={() => openModal(product)} >Modifer</button>
              {' '}
